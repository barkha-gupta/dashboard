...
const DisplaySection: FC = () => {
  return (
    <div className="p-6 flex gap-6">
      <div className="custom-border flex flex-col gap-6 py-3 px-6 w-60">
        <p className="text-secondary font-semibold">Total trips</p>
        <p className="text-2xl font-semibold">18,033</p>
      </div>

      <div className="custom-border py-3 px-6 flex gap-4 w-[325px]">
      ...
      <div className="custom-border flex gap-4 w-[529px]">
